...
@AutoConfigureMockMvc // @Controller, @Service, @Repository Bean 을 모두 로드하여 준다.
...
public class ProductControllerTest {
    ...
    @Autowired // 웹 API 를 테스트할 때 사용. 가짜 요청을 생성할 수 있다.
    private MockMvc mockMvc;

    @BeforeEach // 한글 깨짐으로 인해 WebApplicationContext 의 설정 변경을 통해 UTF-8로 강제 인코딩
    public void setup() {
    ...
    public void getProduct() throws Exception {
        ...
        String url = "http://localhost:" + 8080 + "/products/" + PRODUCT_2.getId();
