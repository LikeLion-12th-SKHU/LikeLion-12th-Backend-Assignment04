...
public class ProductControllerTest {
    ...
    public void saveProduct() throws Exception {
        ...
        final ProductSaveRequestDto requestDto = ProductSaveRequestDto.builder()
                .product_id(PRODUCT_1.getProduct_id())
        ...
        assertThat(all.get(0).getProduct_id()).isEqualTo(PRODUCT_1.getProduct_id());
    ...
    public void getProduct() throws Exception {
        ...
        assertThat(productResponse.getProduct_id()).isEqualTo(PRODUCT_2.getProduct_id());
